...
class State
{
  public:
     ...
     */
    explicit State(const drogon::orm::Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit State(const Json::Value &pJson) noexcept(false);
     ...
     */
    State(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);
  ...
  private:
    friend drogon::orm::Mapper<State>;
    friend drogon::orm::BaseBuilder<State, true, true>;
    friend drogon::orm::BaseBuilder<State, true, false>;
    friend drogon::orm::BaseBuilder<State, false, true>;
    friend drogon::orm::BaseBuilder<State, false, false>;
#ifdef __cpp_impl_coroutine
    friend drogon::orm::CoroMapper<State>;
#endif
  ...
  public:
    ...
    {
        static const std::string sql="select * from " + tableName + " where state = $1";
        return sql;
    }

    static const std::string &sqlForDeletingByPrimaryKey()
    {
        static const std::string sql="delete from " + tableName + " where state = $1";
        return sql;
    }
