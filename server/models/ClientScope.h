...
class ClientScope
{
  public:
    ...
    using PrimaryKeyType = std::tuple<std::string,std::string>;//client_id,scope
     ...
     */
    explicit ClientScope(const drogon::orm::Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit ClientScope(const Json::Value &pJson) noexcept(false);
     ...
     */
    ClientScope(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);
  ...
  private:
    friend drogon::orm::Mapper<ClientScope>;
    friend drogon::orm::BaseBuilder<ClientScope, true, true>;
    friend drogon::orm::BaseBuilder<ClientScope, true, false>;
    friend drogon::orm::BaseBuilder<ClientScope, false, true>;
    friend drogon::orm::BaseBuilder<ClientScope, false, false>;
#ifdef __cpp_impl_coroutine
    friend drogon::orm::CoroMapper<ClientScope>;
#endif
  ...
  public:
    ...
    {
        static const std::string sql="select * from " + tableName + " where client_id = $1 and scope = $2";
        return sql;
    }

    static const std::string &sqlForDeletingByPrimaryKey()
    {
        static const std::string sql="delete from " + tableName + " where client_id = $1 and scope = $2";
        return sql;
    }
