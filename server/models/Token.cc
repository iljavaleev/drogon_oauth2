...
{"access_token","int64_t","bigint",8,0,0,0},
{"refresh_token","int64_t","bigint",8,0,0,0}
};
...
Token::Token(const Row &r, const ssize_t indexOffset) noexcept
{
    if(indexOffset < 0)
    {
        ...
        {
            accessToken_=std::make_shared<int64_t>(r["access_token"].as<int64_t>());
        }
        if(!r["refresh_token"].isNull())
        {
            refreshToken_=std::make_shared<int64_t>(r["refresh_token"].as<int64_t>());
        }
    }
    else
    {
        ...
        if(!r[index].isNull())
        {
            accessToken_=std::make_shared<int64_t>(r[index].as<int64_t>());
        }
        index = offset + 3;
        if(!r[index].isNull())
        {
            refreshToken_=std::make_shared<int64_t>(r[index].as<int64_t>());
        }
    }
...
Token::Token(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false)
{
    ...
    if(!pMasqueradingVector[2].empty() && pJson.isMember(pMasqueradingVector[2]))
    {
        ...
        {
            accessToken_=std::make_shared<int64_t>((int64_t)pJson[pMasqueradingVector[2]].asInt64());
        }
    }
    if(!pMasqueradingVector[3].empty() && pJson.isMember(pMasqueradingVector[3]))
    {
        ...
        {
            refreshToken_=std::make_shared<int64_t>((int64_t)pJson[pMasqueradingVector[3]].asInt64());
        }
    }
}
...
Token::Token(const Json::Value &pJson) noexcept(false)
{
    ...
    if(pJson.isMember("access_token"))
    {
        ...
        {
            accessToken_=std::make_shared<int64_t>((int64_t)pJson["access_token"].asInt64());
        }
    }
    if(pJson.isMember("refresh_token"))
    {
        ...
        {
            refreshToken_=std::make_shared<int64_t>((int64_t)pJson["refresh_token"].asInt64());
        }
    }
}
...
const int64_t &Token::getValueOfAccessToken() const noexcept
{
...
const std::shared_ptr<int64_t> &Token::getAccessToken() const noexcept
{
    return accessToken_;
}
void Token::setAccessToken(const int64_t &pAccessToken) noexcept
{
    accessToken_ = std::make_shared<int64_t>(pAccessToken);
    dirtyFlag_[2] = true;
}
...
const int64_t &Token::getValueOfRefreshToken() const noexcept
{
    static const int64_t defaultValue = int64_t();
    if(refreshToken_)
...
const std::shared_ptr<int64_t> &Token::getRefreshToken() const noexcept
{
    return refreshToken_;
}
void Token::setRefreshToken(const int64_t &pRefreshToken) noexcept
{
    refreshToken_ = std::make_shared<int64_t>(pRefreshToken);
    dirtyFlag_[3] = true;
}
...
Json::Value Token::toJson() const
{
    ...
    if(getAccessToken())
    {
        ret["access_token"]=(Json::Int64)getValueOfAccessToken();
    }
    else
    {
    ...
    if(getRefreshToken())
    {
        ret["refresh_token"]=(Json::Int64)getValueOfRefreshToken();
    }
    else
    {
    ...
    const std::vector<std::string> &pMasqueradingVector) const
{
    ...
    if(pMasqueradingVector.size() == 4)
    {
        ...
        if(!pMasqueradingVector[2].empty())
        {
            if(getAccessToken())
            {
                ret[pMasqueradingVector[2]]=(Json::Int64)getValueOfAccessToken();
            }
            else
            {
        ...
        if(!pMasqueradingVector[3].empty())
        {
            if(getRefreshToken())
            {
                ret[pMasqueradingVector[3]]=(Json::Int64)getValueOfRefreshToken();
            }
            else
            {
