...
class Token
{
  public:
    ...
    const int64_t &getValueOfAccessToken() const noexcept;
    ///Return a shared_ptr object pointing to the column const value, or an empty shared_ptr object if the column is null
    const std::shared_ptr<int64_t> &getAccessToken() const noexcept;
    ///Set the value of the column access_token
    void setAccessToken(const int64_t &pAccessToken) noexcept;
    ...
    const int64_t &getValueOfRefreshToken() const noexcept;
    ///Return a shared_ptr object pointing to the column const value, or an empty shared_ptr object if the column is null
    const std::shared_ptr<int64_t> &getRefreshToken() const noexcept;
    ///Set the value of the column refresh_token
    void setRefreshToken(const int64_t &pRefreshToken) noexcept;
  ...
  private:
    ...
    std::shared_ptr<int64_t> accessToken_;
    std::shared_ptr<int64_t> refreshToken_;
    struct MetaData
    {
